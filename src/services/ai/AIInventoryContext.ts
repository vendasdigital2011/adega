    ...
    try {
      ...
      if (error || !products) {
        return {
          ...
          details_summary: "Nenhum produto registrado em estoque.",
        }
      }
      ...
      return {
        ...
        details_summary: `Total de Produtos: ${products.length}, Valor Total em Estoque: R$ ${totalVal.toLocaleString("pt-BR")}, Produtos no Estoque Mínimo: ${lowStockCount} item(ns).`,
      }
    } catch (e) {
      return {
        total_products_count: 0,
        ...
        low_stock_items: [],
        expiring_products_count: 0,
        details_summary: "Informações de estoque não registradas.",
      }
    }
  }
}
